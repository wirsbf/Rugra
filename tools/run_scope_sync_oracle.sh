...
# (getSizedType/updateType), the unmapped-alias paths (inScope /
# isUnmappedUnaliased), the flag-mask asymmetry (addrtied clear-only,
# nolocalalias set-only, addrforce clears, isFree skip, per-set walk), and
# the typelock/mapentry branches.
set -euo pipefail
...
rugra_base_commit=609981d706edb3e384b148a12ed190028baa1984
rugra_base_tree=1164045197732a078328bf3157367e27cc71fa9a
ghidra_root="$repo_root/ghidra"
metadata="$repo_root/tests/oracle/scope_sync_1204.metadata.json"
cpp_fixture="$repo_root/tests/oracle/scope_sync_1204.cc"
rust_fixture="$repo_root/tests/oracle/scope_sync_1204.rs"
...
special_paths = [
    pathlib.Path("tests/oracle/scope_sync_1204.cc"),
    pathlib.Path("tests/oracle/scope_sync_1204.rs"),
    pathlib.Path("tests/oracle/scope_sync_1204.metadata.json"),
...
metadata = json.loads(special["tests/oracle/scope_sync_1204.metadata.json"])
require("metadata schema", metadata["schema_version"], 1)
require("fixture id", metadata["fixture_id"], "FUNCDATA-SCOPE-SYNC-0001")
...
observed = {
    "cpp_fixture_sha256": sha256(special["tests/oracle/scope_sync_1204.cc"]),
    "rust_fixture_sha256": sha256(special["tests/oracle/scope_sync_1204.rs"]),
...
g++ -std=c++11 -O2 -Wall -Wno-sign-compare \
  ...
  "$oracle_tmp/workspace/tests/oracle/scope_sync_1204.cc" \
  ...
  -o "$oracle_tmp/scope_sync_1204_cpp"
...
"$oracle_tmp/scope_sync_1204_cpp" \
