...
cpp_fixture="$repo_root/tests/oracle/varmap_dupdecl_1204.cc"
rust_fixture="$repo_root/tests/oracle/varmap_dupdecl_1204.rs"
metadata="$repo_root/tests/oracle/varmap_dupdecl_1204.metadata.json"
...
echo "varmap_dupdecl_1204: MATCH"
