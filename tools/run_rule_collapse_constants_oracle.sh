...
cpp_fixture="$repo_root/tests/oracle/rule_collapse_constants_1204.cc"
rust_fixture="$repo_root/tests/oracle/rule_collapse_constants_1204.rs"
runner="$repo_root/tools/run_rule_collapse_constants_oracle.sh"
bfd_include=/tmp/rugra-ghidra-bfd-2.38/usr/include
bfd_header="$bfd_include/bfd.h"
bfd_library=/usr/lib/x86_64-linux-gnu/libbfd-2.38-system.so

oracle_tmp=$(mktemp -d /tmp/rugra-rule-collapse-constants-1204.XXXXXX)
cleanup() {
  case "$oracle_tmp" in
    /tmp/rugra-rule-collapse-constants-1204.??????) rm -rf -- "$oracle_tmp" ;;
...
cp "$metadata" "$snapshot_root/tests/oracle/rule_collapse_constants_1204.metadata.json"
cp "$runner" "$snapshot_root/tools/run_rule_collapse_constants_oracle.sh"
...
require("fixture", metadata["fixture_id"], "RULE-COLLAPSECONSTANTS-0001")
...
expected_matches = {
    ...
    "comparison_carry_family", "float_family_4_8", "error_paths_nocollapse",
    "guards", "symbol_propagation",
}
expected_residuals = {
    "equate_isvalueclose_strictness", "float_int2float_signedness",
    "mixed_size_sright_mask",
}
...
require(
    ...
    {
        "VARNODE-COPYSYMBOL-EQUATE-0001",
        "FLOAT-OPINT2FLOAT-SIGN-0001",
        "OPBEHAVIOR-SRIGHT-SIZEMASK-0001",
    },
)
residual = metadata["residual_union"]
require("residual TODO", residual["todo_id"], "RULE-COLLAPSECONSTANTS-RESIDUAL-0001")
...
g++ -std=c++11 -O2 -Wall -Wno-sign-compare \
  ...
  "$snapshot_root/tests/oracle/rule_collapse_constants_1204.cc" \
...
python3 -I -S - "$snapshot_root/tests/oracle/rule_collapse_constants_1204.metadata.json" \
...
printf 'rule_collapse_constants_1204: covered_projection=11/11 projection_status=MATCH overall_status=UNTESTED residual=RULE-COLLAPSECONSTANTS-RESIDUAL-0001\n'
