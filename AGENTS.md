...
- **测试**: 237/237 通过
- **已完成的核心移植**: identifyInternal/selfIdentify, ruleBlockCat chain, ruleBlockGoto+clipExtraRoots, TraceDAG(BadEdgeScore+visit-count), structure_loops_first, **Datatype get_align_size/get_sub_type/get_hole_size/type_order**, **varmap RangeHint/AliasChecker/MapState/ScopeLocal 算法层 1:1 对齐 + printc 集成 + Stack-spacebase**, **Varnode flag 访问器 (varnode.hh:235-330)**, **Funcdata op-edit API (funcdata.hh:281-479) + op_swap_input**, **get_booleanflip (opcodes.cc:94)**, **ActionRestructureVarnode (coreaction.cc:2274)**, **Rules (13): NegateIdentity/NotDistribute/ConcatZero/XorCollapse/AddMultCollapse/Less2Zero/LessEqual2Zero/BoolNegate/OrMask/AndOrLump/Piece2Zext/Piece2Sext/Bxor2NotEqual**
