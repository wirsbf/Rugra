...
- **测试**: 227/227 通过
- **已完成的核心移植**: identifyInternal/selfIdentify, ruleBlockCat chain, ruleBlockGoto+clipExtraRoots, TraceDAG(BadEdgeScore+visit-count), structure_loops_first, **Datatype get_align_size/get_sub_type/get_hole_size/type_order**, **varmap RangeHint/AliasChecker/MapState/ScopeLocal 算法层 1:1 对齐 + printc 集成 + Stack-spacebase**, **Varnode flag 访问器 (varnode.hh:235-330)**, **Funcdata op-edit API (funcdata.hh:281-479)**, **ActionRestructureVarnode (coreaction.cc:2274)**, **Rules: NegateIdentity/NotDistribute/ConcatZero/XorCollapse/AddMultCollapse/Less2Zero/LessEqual2Zero**
