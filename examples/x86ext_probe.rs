...
fn form_matrix() -> Vec<(&'static str, &'static str, Vec<u8>)> {
    ...
    add("btc", "btc rsi,3Fh", &[0x48, 0x0f, 0xba, 0xfe, 0x3f]);
    add("btc", "btc eax,ebx", &[0x0f, 0xbb, 0xd8]);
    add("bts", "bts [rax],edx", &[0x0f, 0xab, 0x10]);
    add("btr", "btr [rax],edx", &[0x0f, 0xb3, 0x10]);
    add("btc", "btc [rax],edx", &[0x0f, 0xbb, 0x10]);
    add("bts", "bts dword [rbx],5", &[0x0f, 0xba, 0x2b, 0x05]);
    add("btr", "btr dword [rbx],5", &[0x0f, 0xba, 0x33, 0x05]);
    add("btc", "btc dword [rbx],5", &[0x0f, 0xba, 0x3b, 0x05]);
    add("bt", "bt dword [rbx],5", &[0x0f, 0xba, 0x23, 0x05]);
    add("bts", "bts rsi,3Fh", &[0x48, 0x0f, 0xba, 0xee, 0x3f]);
    add("btr", "btr rsi,3Fh", &[0x48, 0x0f, 0xba, 0xf6, 0x3f]);
    add("btc", "btc eax,5", &[0x0f, 0xba, 0xf8, 0x05]);
    add("bt", "bt eax,3Fh", &[0x0f, 0xba, 0xe0, 0x3f]);
    add("bts", "bts rax,rbx", &[0x48, 0x0f, 0xab, 0xd8]);
    add("btr", "btr rax,rbx", &[0x48, 0x0f, 0xb3, 0xd8]);
    add("btc", "btc rax,rbx", &[0x48, 0x0f, 0xbb, 0xd8]);
    add("bt", "bt qword [rbx],5", &[0x48, 0x0f, 0xba, 0x23, 0x05]);
    add("bts", "bts qword [rbx],5", &[0x48, 0x0f, 0xba, 0x2b, 0x05]);
