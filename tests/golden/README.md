...
| `ghidra_sqlite_1204.direct-runner.c` | `/usr/lib/x86_64-linux-gnu/libsqlite3.so.0`(sha `f5a7fc23…`) | 12.0.4(e40ed130) | 2026-09-26 | **第五语料泛化棘轮靶**(GEN5-0001):库级 BFD 契约,**首个 stripped 共享库 profile**(dynsym-only:1339 导出 FUNC 真身+46 PLT 桩=1385 单元,无 .symtab/无 DWARF/库脸无 main),143012 行含 sqlite3VdbeExec 3877 行巨型 switch 脸;`--base 0`;canon headless 档 NO_ORACLE(同上);Rugra 对拍驱动=gen_decompile(RUGRA_GEN_MIRROR=1);oracle 1385/1385 OK 30.3s+determinism 12/12 字节恒等 |
