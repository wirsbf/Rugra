...

{
  ...
  if (PTR___gmon_start___00116fe8 != (undefined *)0x0) {
    iVar1 = (*(code *)PTR___gmon_start___00116fe8)();
  }
  return iVar1;
}
...
/* ---- 0x1022e0: __cxa_finalize (11 bytes) ---- */
...
LAB_00102651:
      ...
      if (iVar4 != 0) goto LAB_00102728;
                    ...
                    /* Unresolved local var: char * nextarg@[???]
                       Unresolved local var: char * flag@[???] */
    pcVar12 = (char *)0x0;
    iVar16 = 1;
    bVar3 = true;
    do {
...

{
  ...
  *(ulong *)((long)clientp + 0x10) = uVar8;
  if (dltotal + ultotal == 0) {
                    /* Unresolved local var: int prevblock@[???]
                       Unresolved local var: int thisblock@[???] */
...

{
  ...
  void *__dest;
                    ...
                    /* Unresolved local var: char * first@[???]
                       Unresolved local var: char * last@[???]
                       Unresolved local var: char * retval@[???]
...

{
  ...
  do {
    ...
    if (__dest == (uint *)0x0) {
      ...
      __dest = realloc(__dest,(long)puVar9 +
                              (long)puVar5 +
...

{
  ...
  bool buffer [256];
                    ...
                    /* Unresolved local var: char * ptr@[???]
                       Unresolved local var: char * string@[???]
                       Unresolved local var: int len@[???]
                       Unresolved local var: int stringlen@[???] */
  bVar15 = 0;
  lVar7 = 0;
  __ptr = (char *)0x0;
  lVar2 = *(long *)(in_FS_OFFSET + 0x28);
  while( true ) {
    uStack_150 = (undefined *)0x103af8;
    pcVar6 = fgets(buffer,0x100,(FILE *)file);
    if (pcVar6 == (char *)0x0) break;
    uStack_150 = (undefined *)0x103b0e;
    pcVar6 = strchr(buffer,0xd);
    if (pcVar6 != (char *)0x0) {
      *pcVar6 = '\0';
    }
    uStack_150 = (undefined *)0x103b23;
    ...
    if (__ptr == (char *)0x0) {
      uStack_150 = (undefined *)0x103bd3;
      __ptr = malloc((long)(iVar3 + 1));
    }
    else {
      uStack_150 = (undefined *)0x103b7d;
      __ptr = realloc(__ptr,(long)(iVar14 + 1));
    }
    uVar11 = lVar10 + 1;
      ...
      *(undefined8 *)(pbVar1 + ((uVar11 & 0xffffffff) - 8)) =
      ...
      for (uVar11 = (ulong)(uVar5 + (int)lVar7 >> 3); uVar11 != 0; uVar11 = uVar11 - 1) {
        *puVar13 = *(undefined8 *)pbVar12;
        pbVar12 = pbVar12 + ((ulong)bVar15 * -2 + 1) * 8;
...

{
  ...
  bool filebuffer [256];
                    ...
                    /* Unresolved local var: int res@[???]
                       ...
                       Unresolved local var: bool[4096] configbuffer@[???]
...
LAB_00103e8a:
    ...
    if ((bool)filename[1] != false) goto LAB_00103d26;
                    ...
                    /* Unresolved local var: char * line@[???]
                       Unresolved local var: char * tok1@[???]
                       Unresolved local var: char * tok2@[???] */
  if (__stream != (FILE *)0x0) {
...

{
  ...
  pCVar13 = (Configurable *)aliases;
                    /* Unresolved local var: bool letter@[???]
                       Unresolved local var: char * parse@[???]
                       Unresolved local var: int res@[???]
                       Unresolved local var: int j@[???]
                       Unresolved local var: int hit@[???] */
      ...
      if (*(char *)&local_5b8->useragent == '@') {
        ...
        if (iVar14 == 0) {
          ...
          pCVar9 = (Configurable *)fopen((char *)local_5b8,"r");
                    ...
                    /* Unresolved local var: bool[256] buffer@[???]
                       Unresolved local var: char * ptr@[???]
                       Unresolved local var: char * string@[???]
                       Unresolved local var: int len@[???]
                       Unresolved local var: int stringlen@[???] */
...
switchD_00104c45_caseD_7d:
      *pcVar7 = '\0';
      ppcVar6 = realloc(pUVar2->pattern[iVar4].content.Set.elements,
...

{
  ...
  char *pcVar8;
                    ...
                    /* Unresolved local var: char * buf@[???]
                       Unresolved local var: URLPattern pat@[???]
