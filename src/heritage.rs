...
impl Heritage {
    ...
    pub fn place_multiequals_direct(
        ...
        for vn_ref in &vbank.loc_tree {
            ...
            // Ghidra: Register space (including flag registers 0x200-0x20f)
            // participates fully in SSA heritage. Do NOT skip flag registers.
            // Ghidra's .pspec marks flag registers with group="FLAGS" for
            // UI display, but does NOT prevent SSA. DeadCode handles removal
            // of unused flag ops via normal consume propagation.
    ...
    pub fn rename_direct(&mut self, vbank: &mut VarnodeBank, bblocks: &crate::block::BlockGraph) {
        ...
        for vn_ref in &vbank.loc_tree {
            ...
            // Ghidra: flag registers participate fully in SSA heritage.
            // Do NOT skip.
