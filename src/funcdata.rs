...
fn scope_local_in_scope(
    ...
    // address.cc:486: addr.getOffset()+size-1 — same uint8 modular domain
...
// address.cc:486 (RangeList::inRange via database.hh:597 Scope::inScope)
...
fn test_scope_local_in_scope_wraps_at_space_top() {
    ...
    // (address.cc:486) — pin the oracle's own answer, true.
    assert!(scope_local_in_scope(
        &scope,
        AddressSpace::Stack,
        0xffff_ffff_ffff_ffff,
