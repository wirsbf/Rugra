...
pub trait Action: Send + Sync {
    ...
    // protected ActionRestartGroup::curstart field read that the locked C++
    // oracle fixtures perform (same protected-field access pattern; the field
    // itself is action.hh:175, driven by action.cc:553-582). Default 0 for
...
impl Action for ActionRestartGroup {
    ...
    // RUGRA-GLUE: trait-level read-only passthrough of the protected curstart (action.hh:175) for the stage-projection emitter (see Action::fixture_curstart)
