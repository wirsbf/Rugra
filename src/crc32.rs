//! CRC32 — faithful port of `crc32.hh` / `crc32.cc` (74 lines).
//!
//! Table and function for computing a 32-bit Cyclic Redundancy Check (CRC).
//! Used by `stringmanage` for internal string hashing and by the marshal
//! Packed format.
//!
//! Ghidra reference:
//! ghidra/Ghidra/Features/Decompiler/src/decompile/cpp/crc32.{hh,cc}.

/// Table for bytewise calculation of a 32-bit CRC. Faithful to `crc32tab`
/// (crc32.cc:21). The 256-entry lookup table for the standard CRC32 polynomial
/// (0xEDB88320).
...
/// Feed 8 bits into a CRC register. Faithful to `crc_update` (crc32.hh:33).
///
