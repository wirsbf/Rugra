...
### 量化对比基线（2026-06-23，2026-07-02 更新）
...
| 结构缺陷（2026-07-02 新增） | 17/24 函数有缺陷 | 待测 |
| 变量编号问题（2026-07-02 新增） | 332 个 | 待测 |
...
### 最终控制流差距状态（2026-06-23 会话结束，2026-07-02 度量更新）

interleaved 规则框架已实现但对复杂 CFG 无额外改善。
