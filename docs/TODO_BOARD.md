...
| `ANN-B` | P0 | IN_PROGRESS | pipeline_reachability | `flow.rs` 18 个 + `callgraph.rs` 2 个 accessor/helper | `src/{flow,callgraph}.rs`, `docs/api/{flow,callgraph}.md` | 精确集合=`find_fn_violations`@fcc5142；验收指定文件 annotation+refs+doc-sync；evidence commit=pending | 2026-08-11 |
