...
| `ANN-O` | P0 | IN_PROGRESS | parser_ruleparse_1204 | expanded scanner: `pcodeparse.rs` 3 个 const token helpers | `src/pcodeparse.rs`, `docs/api/pcodeparse.md` | 依赖 `GATE-SCANNER-0001` 最终验收；读取锁定 parser declarations/consumers，零行为改动 | 2026-08-12 |
