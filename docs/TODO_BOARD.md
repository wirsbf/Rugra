...
| `GATE-REF-OPBEHAVIOR` | P0 | REVIEW | print_pipeline_1204 | `opbehavior.rs` 9 个 PTRADD/PTRSUB/POPCOUNT/LZCOUNT refs | `src/opbehavior.rs`, `docs/api/opbehavior.md` | locked 12.0.4 定义起始行已核；另修 PIECE/SUBPIECE strict false-negative；零行为改动；scoped refs/annotations/doc/check 通过；evidence commit=pending | 2026-08-12 |
