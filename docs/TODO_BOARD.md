...
| `SLEIGH-0002` | P0 | READY | unassigned | `SleighLifter::lift_from_func` pspec context | `src/disasm/sleigh_lift.rs`, API/tests | `GATE-0001` + `SLEIGH-0001` 已完成；`48 89 f8 c3` 首指令必须 length=3 且产生 COPY，context/tracked state 与 12.0.4 fixture 完整同输出 | 2026-08-12 |
