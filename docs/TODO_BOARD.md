...
| `ANN-M` | P0 | IN_PROGRESS | cover_merge_foundation_1204 | expanded scanner: `blockaction.rs` 2 个 const helpers | `src/blockaction.rs`, `docs/api/blockaction.md` | 依赖 `GATE-SCANNER-0001` 最终验收；核心文件仅 provenance，不改变行为/状态 | 2026-08-12 |
