...
| `ANN-K` | P0 | IN_PROGRESS | print_pipeline_1204 | expanded scanner: `opbehavior.rs` 42 个 const constructors | `src/opbehavior.rs`, `docs/api/opbehavior.md` | 依赖 `GATE-SCANNER-0001` 最终验收；逐项绑定真实 constructor 或具体 Rust glue，零行为改动 | 2026-08-12 |
